## function to generate pcoa plots, flips both axes
## input: counts table, metadata, colors for metadata groups, legendlocation, and plottitle
## output: pcoa plot

generatePCOAPlots_flipBothaxes = function(mycountsTable, mymetagroup,mycolors, 
  ...
  b=plot((summary(myPcoa)$site[,1]*(-1)),(summary(myPcoa)$site[,2]*(-1)),
